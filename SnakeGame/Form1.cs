...
namespace SnakeGame
{
    public partial class Form1 : Form
    {
        ...
        private void startGame()
        {
            ...
            Settings.Width = Convert.ToInt32(Math.Round(widthUpDown.Value, 0));
            Settings.Height = Convert.ToInt32(Math.Round(heightUpDown.Value, 0));
            Settings.Speed = Convert.ToInt32(Math.Round(speedUpDown.Value, 0));
            gameTimer.Interval = 1000 / Settings.Speed; // Changing the game time to settings speed
        ...
        private void widthUpDown_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void heightUpDown_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                startGame();
        ...
        private void speedUpDown_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                startGame();
